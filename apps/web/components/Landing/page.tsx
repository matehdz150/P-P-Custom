	...
	return (
		<div style={{ display: "flex", alignItems: "center", gap: 8 }}>
			<svg width={size * 1.1} height={size} viewBox="0 0 44 40" fill="none">
				...
				<path
					d="M14 12h7.2a4.8 4.8 0 0 1 0 9.6H17v6.4h-3V12z M17 14.8v4h4.2a2 2 0 0 0 0-4H17z"
					fill={color}
				/>
			</svg>
			<span
...
function CapObject({ accent }: { accent: string }) {
	return (
		<svg viewBox="0 0 220 180" width="100%" height="100%">
			...
			<path
				d="M30 110 Q30 50 110 50 Q190 50 190 110 L190 120 L30 120 Z"
				fill="#1A1410"
			/>
			<path
				d="M30 110 Q30 50 110 50 Q190 50 190 110 L190 120 L30 120 Z"
			...
			/>
			<path
				d="M14 120 Q14 138 110 142 Q206 138 206 120 L190 120 L30 120 Z"
				fill="#1A1410"
			/>
			<path
				d="M82 60 Q82 52 110 50 Q138 52 138 60 L138 120 L82 120 Z"
				fill="#2A2018"
			/>
			<g transform="translate(110 86)">
				...
				/>
				<path
					d="M0 -11 L3 -3 L11 -3 L4.5 2 L7 10 L0 5 L-7 10 L-4.5 2 L-11 -3 L-3 -3 Z"
					fill="#1A1410"
				/>
			</g>
...
function ToteObject({ accent }: { accent: string }) {
	return (
		<svg viewBox="0 0 220 220" width="100%" height="100%">
			<path
				d="M40 60 L180 60 L188 200 L32 200 Z"
				fill="#F2EADB"
				stroke="#1A1410"
				strokeWidth="2"
			/>
			...
			/>
			<path
				d="M70 60 Q70 14 110 14 Q150 14 150 60"
				fill="none"
				stroke="#1A1410"
				strokeWidth="6"
				strokeLinecap="round"
...
function ShirtObject({ accent }: { accent: string }) {
	return (
		<svg viewBox="0 0 240 220" width="100%" height="100%">
			...
			/>
			<path
				d="M60 100 L60 200 L180 200 L180 100"
				fill="none"
				stroke="#FAF5EC"
				opacity=".08"
				strokeWidth="1"
		...
		>
			<div style={{ maxWidth: 1240, margin: "0 auto", position: "relative" }}>
				...
				>
					<button
						className="btn"
						style={{ fontSize: 19, padding: "20px 36px" }}
					>
				...
				<div style={{ position: "relative", marginTop: 60, height: 420 }}>
					...
					>
						...
						>
							<div
								className="mono"
								style={{ fontSize: 10, color: tokens.ink2, marginBottom: 4 }}
							>
								HILO DMC · 12 COLORES
							</div>
					...
					>
						<div style={{ textAlign: "center" }}>
							<svg width="44" height="44" viewBox="0 0 44 44" fill="none">
								<path
									d="M22 10 L22 30 M14 18 L22 10 L30 18"
									stroke={tokens.ink}
									strokeWidth="2.4"
									strokeLinecap="round"
									strokeLinejoin="round"
							...
							<div
								className="mono"
								style={{ fontSize: 11, marginTop: 8, color: tokens.ink2 }}
							>
								.PNG .SVG .JPG .AI
							</div>
						</div>
				...
				<div style={{ position: "relative", height: "100%", padding: 14 }}>
					<div
						style={{
							...
							position: "relative",
							overflow: "hidden",
							boxShadow: `inset 0 0 0 6px ${tokens.bg2}`,
						}}
					>
						<svg
							viewBox="0 0 100 100"
						...
						>
							<g transform="translate(50 50)">
								<path
									d="M0 -22 L4.5 -8 L19 -7 L7.5 1.5 L11 15 L0 7 L-11 15 L-7.5 1.5 L-19 -7 L-4.5 -8 Z"
									fill={tokens.accent}
								/>
								<path
									d="M0 -22 L4.5 -8 L19 -7 L7.5 1.5 L11 15 L0 7 L-11 15 L-7.5 1.5 L-19 -7 L-4.5 -8 Z"
			...
			vis: (
				<div style={{ position: "relative", height: "100%" }}>
					...
					>
						<div
							style={{
								...
								background: tokens.paper,
								borderLeft: `1.5px dashed ${tokens.ink}`,
								borderRight: `1.5px dashed ${tokens.ink}`,
							}}
						/>
						<div
							style={{
								...
								padding: "4px 8px",
								background: tokens.paper,
								border: `1.2px dashed ${tokens.ink}`,
								borderRadius: 4,
							}}
						>
							<div
					...
					>
						<div
							className="mono"
							style={{ fontSize: 9, fontWeight: 600, letterSpacing: ".1em" }}
						>
							3–7 DÍAS
						</div>
					</div>
		...
		<section id="how" style={{ padding: "100px 36px", background: tokens.bg }}>
			<div style={{ maxWidth: 1240, margin: "0 auto" }}>
				...
				>
					<h2
						className="display"
						style={{ fontSize: "clamp(40px, 6vw, 88px)", maxWidth: "14ch" }}
					>
						De idea a bordado en{" "}
						<span style={{ color: tokens.accent }}>tres pasos</span>
					</h2>
					<p
						style={{
							maxWidth: 420,
					...
					>
						Nuestra plataforma hace lo difícil: digitaliza tu diseño, lo asigna
						al taller correcto y te avisa en cada paso.
					</p>
				</div>
				...
				>
					{steps.map((s) => (
						...
						>
							...
							<h3
								className="display"
								style={{ fontSize: 28, lineHeight: 1.05, marginTop: 6 }}
							>
								{s.title}
							</h3>
							<p style={{ fontSize: 15, color: tokens.ink2, lineHeight: 1.5 }}>
								{s.body}
							</p>
						</div>
					))}
		...
		>
			<div style={{ maxWidth: 1240, margin: "0 auto" }}>
				...
				>
					...
					<span
						style={{
							flex: 1,
							height: 1.5,
							borderTop: `1.5px dashed ${tokens.bg}`,
							opacity: 0.4,
						}}
					/>
				</div>
				...
				>
					...
					>
						Diseñar bordados{" "}
						<span style={{ color: tokens.accent }}>nunca fue así</span>
					</h2>
					<p
						style={{
							maxWidth: 420,
					...
					>
						Vista previa con textura de hilo real. Cambia colores, escala, mueve
						y obtén el conteo de puntadas al instante.
					</p>
				</div>
				...
				>
					...
					>
						<div style={{ display: "flex", gap: 8, alignItems: "center" }}>
							...
							<span
								className="mono"
								style={{ fontSize: 11, opacity: 0.6, marginLeft: 14 }}
							>
								proyecto · gorra-snapback-negra.pp
							</span>
						</div>
					...
					>
						...
						>
							{tools.map((t, i) => (
								...
								>
									...
									<span
										className="mono"
										style={{ fontSize: 9, opacity: i === 2 ? 1 : 0.6 }}
									>
										{t.label}
									</span>
								</button>
						...
						<div
							style={{
								...
								position: "relative",
								background:
									"radial-gradient(circle at 50% 50%, #3D2E22 0%, #2A2018 70%)",
							}}
						>
							<div
								style={{
							...
							>
								...
								>
									...
									<g transform="translate(200 165)">
										<path
											d="M-130 -20 Q-130 -80 0 -80 Q130 -80 130 -20 L130 0 L-130 0 Z"
											fill="#1A1410"
										/>
										<path
											d="M-150 0 Q-150 25 0 30 Q150 25 150 0 L130 0 L-130 0 Z"
											fill="#0F0A06"
										/>
										<g transform="translate(0 -42)">
											...
											<g>
												<path
													d="M0 -20 L5 -6 L20 -5 L8 3 L12 18 L0 9 L-12 18 L-8 3 L-20 -5 L-5 -6 Z"
													fill="#FF5A1F"
												/>
												<path
													d="M0 -20 L5 -6 L20 -5 L8 3 L12 18 L0 9 L-12 18 L-8 3 L-20 -5 L-5 -6 Z"
								...
								>
									{Array.from({ length: 20 }).map((_, i) => (
										<div
											...
											style={{
												flex: 1,
												borderLeft: "1px solid rgba(26,20,16,.15)",
												height: i % 5 === 0 ? 12 : 6,
												marginTop: 6,
											}}
										/>
								...
								>
									...
									<div
										style={{ width: 1, background: "rgba(250,245,236,.2)" }}
									/>
									<div>
										<div className="mono" style={{ fontSize: 9, opacity: 0.6 }}>
											TIEMPO
						...
						>
								...
								{["Satin", "Tatami", "Contorno"].map((s, i) => (
									<div
										...
										style={{
											...
											marginBottom: 4,
											background:
												i === 0 ? "rgba(255,90,31,.15)" : "transparent",
											border:
												i === 0
							...
							<div
								style={{
									...
									borderRadius: 10,
									background: "#0F0A06",
									border: "1px dashed #3D2E22",
								}}
							>
								<div
									className="mono"
									style={{ fontSize: 10, opacity: 0.5, marginBottom: 6 }}
								>
									COTIZACIÓN ESTIMADA
								</div>
								<div
									className="display"
									style={{ fontSize: 32, color: tokens.accent }}
								>
									$185{" "}
									<span
										style={{ fontSize: 13, color: tokens.bg, opacity: 0.6 }}
									>
										/ pieza
									</span>
								</div>
		...
		Gorras: [
			{
				name: "Snapback negra",
				price: "$185",
				obj: <CapObject accent={tokens.accent} />,
			},
			{
				name: "Trucker beige",
				price: "$210",
				obj: <CapObject accent={tokens.lilac} />,
			},
			{
				name: "Dad cap mostaza",
				price: "$170",
				obj: <CapObject accent={tokens.pink} />,
			},
			{
				name: "5-panel pro",
				price: "$240",
				obj: <CapObject accent={tokens.green} />,
			},
		],
		Playeras: [
			{
				name: "Polo piqué",
				price: "$320",
				obj: <ShirtObject accent={tokens.accent} />,
			},
			{
				name: "T-shirt heavy",
				price: "$220",
				obj: <ShirtObject accent={tokens.lilac} />,
			},
			{
				name: "Camisa oxford",
				price: "$420",
				obj: <ShirtObject accent={tokens.green} />,
			},
			{
				name: "Sudadera",
				price: "$390",
				obj: <ShirtObject accent={tokens.pink} />,
			},
		],
		Mochilas: [
			{
				name: "Tote canvas",
				price: "$160",
				obj: <ToteObject accent={tokens.accent} />,
			},
			{
				name: "Tote orgánica",
				price: "$190",
				obj: <ToteObject accent={tokens.green} />,
			},
			{
				name: "Tote XL",
				price: "$220",
				obj: <ToteObject accent={tokens.lilac} />,
			},
			{
				name: "Tote dual",
				price: "$240",
				obj: <ToteObject accent={tokens.pink} />,
			},
		],
		Parches: [
			{
				name: "Redondo 7cm",
				price: "$45",
				obj: <PatchObject accent={tokens.accent} />,
			},
			{
				name: "Redondo 10cm",
				price: "$65",
				obj: <PatchObject accent={tokens.lilac} />,
			},
			{
				name: "Iron-on velcro",
				price: "$80",
				obj: <PatchObject accent={tokens.pink} />,
			},
			{
				name: "Forma libre",
				price: "$95",
				obj: <PatchObject accent={tokens.green} />,
			},
		],
		Toallas: [
			{
		...
		<section style={{ padding: "100px 36px" }}>
			<div style={{ maxWidth: 1240, margin: "0 auto" }}>
				...
				>
					<h2
						className="display"
						style={{ fontSize: "clamp(40px, 6vw, 88px)", maxWidth: "16ch" }}
					>
						Bordamos sobre{" "}
						<span style={{ color: tokens.accent }}>casi todo</span>
					</h2>
				</div>
						...
						>
							...
							>
								<div>
									...
									<div
										className="mono"
										style={{ fontSize: 10, color: tokens.ink2, marginTop: 2 }}
									>
										DESDE
									</div>
								</div>
				...
				>
					...
					>
						<div style={{ maxWidth: 560 }}>
							...
							>
								Empieza gratis. Sin tarjeta. Cotizamos en menos de 24 horas con
								un taller cerca de ti.
							</p>
						</div>
						<button
				...
				<div style={{ maxWidth: 1240, margin: "0 auto" }}>
					...
					>
						<div>
							...
							>
								Plataforma de bordado a medida que conecta a clientes con
								talleres reales. Hecho en CDMX.
							</p>
						</div>
						{[
							{
								h: "Producto",
								l: ["Editor", "Catálogo", "Plantillas", "Para empresas"],
							},
							{
								h: "Compañía",
								l: ["Sobre P&P", "Talleres aliados", "Empleo", "Prensa"],
							},
					...
					<div
						style={{
							...
							marginTop: 48,
							paddingTop: 24,
							borderTop: "1px solid rgba(26,20,16,.1)",
						}}
					>
						<div className="mono" style={{ fontSize: 11, color: tokens.ink2 }}>
							© 2026 P&amp;P — TODOS LOS DERECHOS RESERVADOS
						</div>
						<div
							className="mono"
							style={{
