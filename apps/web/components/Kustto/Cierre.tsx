		...
		<section className="bg-lima px-5 py-16 md:px-11 md:py-[110px]">
			<div className="flex flex-col items-center gap-5 md:gap-[30px]">
				...
				>
					<Link
						href="/catalogo"
						className="flex h-14 w-full items-center justify-center gap-2.5 rounded-full bg-tinta text-[17px] font-semibold text-hueso motion-safe:transition-[transform,box-shadow] motion-safe:duration-300 motion-safe:ease-out motion-safe:hover:-translate-y-0.5 motion-safe:hover:shadow-lg md:h-[62px] md:w-auto md:px-10 md:text-lg"
					>
						Empieza a diseñar
						<svg
							width="15"
