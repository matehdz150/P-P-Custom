	...
	return (
		<Card className="p-4">
			<div className="flex items-center justify-between gap-3 mb-3">
				...
				<div className="text-xs text-muted-foreground">{value.length} / 2+</div>
			</div>
			...
			{uploading && (
				<p className="text-sm text-muted-foreground mb-3">Subiendo imágenes…</p>
			)}
			...
			{value.length > 0 && value.length < 2 && (
				<p className="text-sm text-red-600 mt-3">Te falta 1 imagen mínimo.</p>
			)}
		</Card>
	);
}
